...
import br.com.aleferamos.BookStore.controllers.dto.ErroDto;
...
public class ResourceExceptionHandler {
    ...
    @ExceptionHandler(br.com.aleferamos.BookStore.exceptions.RegistroNaoEncontradoException.class)
    public ErroDto handle(br.com.aleferamos.BookStore.exceptions.RegistroNaoEncontradoException exception) {
        String message = messageSource.getMessage(exception.getMessage(), null, LocaleContextHolder.getLocale());
        return new ErroDto(message);
    }

    @ResponseStatus(code = HttpStatus.BAD_REQUEST)
    @ExceptionHandler(br.com.aleferamos.BookStore.exceptions.RegraDeNegocioException.class)
    public ErroDto handle(br.com.aleferamos.BookStore.exceptions.RegraDeNegocioException exception) {
        String message = messageSource.getMessage(exception.getMessage(), null, LocaleContextHolder.getLocale());
        return new ErroDto(message);
    }
}